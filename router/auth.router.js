...
import { userSignInSchema, createUserSchema } from "../schema/user.schema.js";
...
router.post('/signin', validator(userSignInSchema), accountExistsSignin, accountHasBeenVerified, passwordIsOk, signin);
